...
<section class="gallery-hero">
    <div class="container">
        ...
        <h1 style="font-family: var(--font-heading); font-size: clamp(3rem, 6vw, 5rem); margin-bottom: 1rem;">The
            Gallery</h1>
        <p class="lead mx-auto" style="max-width: 600px; opacity: 0.8; font-weight: 300;">
            A visual record of Lucy's journey, from the Kilifi Wellness Villa to speaking engagements and quiet moments
            of reflection.
        </p>
    </div>
</section>
            ...
            <?php if (count($images) > 0): ?>
                <?php foreach ($images as $img): ?>
                    <div class="gallery-item"
                        onclick="openLightbox('assets/images/gallery/<?= htmlspecialchars($img['filename']) ?>')">
                        <img src="assets/images/gallery/<?= htmlspecialchars($img['filename']) ?>" class="gallery-img"
                            alt="Gallery Image">
