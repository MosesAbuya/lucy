...
<style>
    ...
    .pledge-checkbox-label:hover { opacity: 1; }
    .pledge-checkbox {
        margin-top: 6px;
        margin-right: 15px;
    ...
    <div class="container text-center">
        ...
        <div class="pledge-container" id="pledgeApp">
            ...
            <div class="pledge-step active" id="step1">
                ...
                <h2 style="font-family: var(--font-heading); color: var(--color-gold); font-size: 2.5rem; margin-bottom: 1rem;">The Choose Yourself Pledge</h2>
                <p style="font-size: 1.2rem; font-weight: 300; opacity: 0.9; margin-bottom: 2.5rem;">
                    Thousands of women are carrying weight that no scale can measure. This is your invitation to finally put yourself back on your own list.
                </p>
            ...
            <div class="pledge-step" id="step2">
                <h3 style="color: var(--color-ivory); margin-bottom: 2rem; font-family: var(--font-heading);">What is your name?</h3>
            ...
            <div class="pledge-step" id="step3">
                <h3 style="color: var(--color-ivory); margin-bottom: 1rem; font-family: var(--font-heading);">I, <span id="displayName" class="text-gold"></span>, promise to...</h3>
            ...
            <div class="pledge-step" id="step4">
                ...
                <h3 style="color: var(--color-gold); margin-bottom: 1rem; font-family: var(--font-heading);">Pledge Signed.</h3>
                ...
                <p style="font-size: 0.9rem; opacity: 0.7; margin-bottom: 2rem;">
                    "The woman I was looking for was not behind me. She was waiting inside the life I was still willing to build." — Lucy Mworia
                </p>
                
                <div class="d-flex flex-column gap-3">
                    <button class="btn-gold-solid" onclick="sharePledge()"><i class="fas fa-share-alt me-2"></i> Share on WhatsApp</button>
