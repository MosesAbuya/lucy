...
<head>
    ...
    <meta property="og:description"
        content="The definitive memoir by Lucy Mworia. Discover how she reclaimed her health, lost 30kg, and found herself again.">
    ...
    <?php if (isset($extra_css)): ?>
        <link rel="stylesheet"
            href="assets/css/pages/<?php echo $extra_css; ?>.css?v=<?php echo filemtime('assets/css/pages/' . $extra_css . '.css'); ?>">
    <?php endif; ?>
...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top hairline-bottom"
        style="background-color: var(--color-ink-translucent); backdrop-filter: blur(10px); transition: background-color var(--transition-slow);">
        <div class="container">
            <!-- Removed the slash/thread icon before text as requested -->
            <a class="navbar-brand" href="index"
                style="font-family: var(--font-heading); font-size: 1.5rem; letter-spacing: 0.05em; color: var(--color-gold);">
                Lucy Mworia
            </a>
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0"
                    style="font-family: var(--font-ui); font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.1em;">
                    <li class="nav-item">
                    ...
                    <li class="nav-item ms-lg-3 d-flex align-items-center mt-3 mt-lg-0">
                        <button id="themeToggleBtn"
                            style="background: none; border: 1px solid var(--color-gold); color: var(--color-gold); padding: 0.4rem 0.6rem; border-radius: 4px; cursor: pointer; display: flex; align-items: center; justify-content: center; width: 34px; height: 34px;"
